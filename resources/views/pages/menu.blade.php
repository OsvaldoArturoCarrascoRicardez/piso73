...
@section('content')
            ...
            <div class="row">
                ...
                <div class="our-menu-details">
                            ...
                            @foreach($cat->products as $pro)
                                ...
                                <div class="clearfix {{$pro->category_id}} all marginBtn">
                                    <div class="col-sm-2"><img class="img-circle" width="100"
                                                               src="{{url('uploads/products/thumb/' . $pro->id . '.jpg')}}"
                                    ...
                                    @foreach($titles as $key=>$t)
                                        ...
                                        <div class="or-rgt-menu col-xs-12 col-sm-3">
                                            <h1>{{$t }} <strong
                                                        class="pull-right"><?php echo $currency; ?>{{$prices[$key]}}</strong>
                                            </h1>
                    ...
                    <div class="col-xs-12 col-sm-3 col-lg-3 bg-grey menu-list no-pad">
                        ...
                        <ul id="CartHTML">
                            <li class="list-pad">VAT(<?php echo setting_by_key("vat"); ?>%) &ensp;<span
                                        class="pull-right"> 0.00</li>
                ...
                <div class="modal-body col-sm-12">
                    ...
                    <div class="col-sm-6 col-lg-6 form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name"
                               autocomplete="off" data-field_type="input">
                    </div>
                    <div class="col-sm-6 col-lg-6 form-group">
                        <label>Email</label>
                    ...
                    <div class="col-sm-6 col-lg-6 form-group">
                        <div class="radio">
                            <label><input type="radio" class="payment_option" checked value="cash" name="payment">Cash
                                On Delivery</label>
                        </div>
                    ...
                    <span id="card_form">
						...
						<div class="col-sm-4 col-lg-4 form-group">
							<label>CC Code</label>
							<input type="text" class="form-control" id="cc_code" name="company"
                                   placeholder="Card Number">
						</div>
						</span>
                    <?php } ?>
    ...
    <script>
        $("body").on("click", ".ConfirmOrder", function () {
            ...
            if (email == "") {
                msg += "Email es Requerido<br>";
            }

            if (phone == "") {
                msg += "Tel is Requerido<br>";
            }
            if (address == "") {
                msg += "dirección is Requerido<br>";
            }
            if (msg) {
                swal("", msg, "error");
                return false;
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    $(".ConfirmOrder").html('Confirmar Orden');
                    swal({
                        title: '',
                        type: 'success',
                        text: obj['message']
