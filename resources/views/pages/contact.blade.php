...
@section('content')
    ...
    <section class="banner-sec internal-banner"
             style="background-image:url(https://scontent.fmex15-1.fna.fbcdn.net/v/t1.6435-9/68280269_107727443911999_7809220592556572672_n.jpg?_nc_cat=103&ccb=1-5&_nc_sid=6e5ad9&_nc_ohc=ItYiu4TzMrIAX8TX-bG&_nc_ht=scontent.fmex15-1.fna&oh=019238bf40abc4232b503a604d479093&oe=61714071)">
            ...
            @if(true)
                <div class="row">
                    ...
                    <div class="contact-middle-area">
                        ...
                        <p><a style="color:#dd2646" ;="">¡Gracias por visitarnos!</a> Para cualquier duda que tengas al
                            respecto por favor llenar el siguiente formulario, tus comentarios son muy importantes para
                            nosotros.</p>
                            ...
                            <div class="quick-contact-box-left">
                                ...
                                <form name="contact" id="contact" method="post">
                                    <div class="contact-form-details">
                                        <ul id="contact-form">
                                            <li><input id="name" type="text" name="name" class="first-field"
                                                       placeholder="Your Name"></li>
                                            <li><input type="text" name="email" id="email" class="second-field"
                                                       placeholder="Your Email"></li>
                                            <li><textarea placeholder="Your Message" name="message" id="message"
                                                          class="forth-field"></textarea></li>
                                            <li>
                                                <button name="contact" type="button" id="contact-submit"
                                                        class="input-submit submit">Submit
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div id="contact-success">
                                        Your message sent sucessfully to our team and they will be in touch with you
                                        asap.
                                    </div>
            ...
            <div class="contact-list clearfix">
                <ul>
                    ...
                    <li class="col-md-4">
                        ...
                        <h5>Telefóno</h5>
                        <h6>¡¡LLamanos!! Te atenderemos con mucho gusto </h6>

                        <a href="#">Tel. :{!! setting_by_key('phone')!!}</a>
                    ...
                    <li class="col-md-4">
                        ...
                        <h5>Correo</h5>
                        <h6>Pedidos y atención a clientes.</h6>
    ...
    <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?sensor=false&key=AIzaSyBRy4cuNgPMeS5sDUj8rZ8Ql4_BkMMf4TM"></script>
    <script>
