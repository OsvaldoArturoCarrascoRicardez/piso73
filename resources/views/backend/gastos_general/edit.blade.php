    ...
    <div class="col-lg-8">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <form action="{{ url('ctrlgastos') }}" class="form-horizontal" method="POST" 
			...
			<label class="control-label col-sm-2" for="importe">Importe: </label> 
				<div class="col-sm-10">
				  <div class="input-group">
					...
					<input id="importe" name="importe" type="text" class="form-control"  required  value="{{ $gastos->price }}"  step="0.01"  />	
  ...
  -moz-appearance: textfield;
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="description" name="description"  
                	placeholder="Escriba una descripción breve. Ejem: Pan"  value="{{ $gastos->title }}"   required  />	
              </div>
            </div>
            {{--  Opcional a agregar...  --}}
            <!-- div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="descriptionLarga" name="descriptionLarga"  
                	placeholder="Escriba una descripción breve. Ejem: Pan de caja, por unidad" value="{{ $gastos->description }}" />
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-sm-8 col-sm-offset-2">
                <a class="btn btn-white" href="{{ route('ctrlgastos.index') }}"> Regresar </a>
...
<script>
	...
	function _submit(e){
		...
		//fdata.append( 'expense_amount', $("#importe").val() );
