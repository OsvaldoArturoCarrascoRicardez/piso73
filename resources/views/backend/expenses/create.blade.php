      ...
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <form action="{{ url('products22') }}" class="form-horizontal" method="POST" 
            ...
            {{--          --}}
            <div class="form-group">
				<label class="control-label col-sm-2" for="price">Importe: </label> 
					<div class="col-sm-4">
					  <div class="input-group">
						<div class="input-group-addon">
						  <i class="fa fa-dollar"></i>
						</div> 
						<!-- input id="price" name="price" type="number" class="form-control"  required  step="0.01"  / -->
						<input id="price" name="price" type="text" class="form-control"  required  step="0.01"  />
            ...
            type='number' 
         inputMode='decimal'
         placeholder='12065.66' 
         onFocus="this.type='number'; this.value=this.lastValue" 
         onBlur="this.type=''; this.lastValue=this.value; this.value=this.value==''?'':(+this.value).toLocaleString('es-MX')" / -->
  ...
  -moz-appearance: textfield;
            ...
            <div class="form-group">
              <div class="col-sm-4 col-sm-offset-2">
                <a class="btn btn-white" href="{{ route('expenses.index') }}"> @lang('common.cancel')</a>
...
<!-- script src="//nosir.github.io/cleave.js/js/lib.js"></script -->
