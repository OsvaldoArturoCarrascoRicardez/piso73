	...
	<tbody>
		<tr>
			<td style="background-color: #18A689; padding: 15px 20px;">
				<span style="float: right;margin-top: 10px; color: #FFF;">: {{date("m/d/Y")}}</span>
				<img src="{{public_path('uploads/logo.jpg')}}" alt=""  style="width: 100px; height: 100px;" />
				<?php  /*img src="{{url('uploads/logo.jpg')}}" alt="">
				<span> --{{url('uploads/logo.jpg')}}-- </span    __style="width: 150px; height: 150px;"  */ ?>
			</td>
		</tr>
...
<div class="pdf-footer">
	<p>Printed by {{Auth::user()->name}} on {{date("m/d/Y")}}.</p>
</div>
