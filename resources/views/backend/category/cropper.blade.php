...
$(document).on("change","#cropper",function() {
       var imagecheck=$(this).data('imagecheck'),
		...
		alert('Debe elejir una imagen Valida.');
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<h4 class="modal-title">Imagen para @lang('common.categories')</h4>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" id="loader"></button>
		  ...
		  <input type="button" class="btn btn-primary" id="Save" value="Guardar Imagen">  </button>
