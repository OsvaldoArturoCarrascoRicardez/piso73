                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
						...
						<div class="form-group">
                            <label for="company_name" class="col-sm-2 control-label">Nombre a mostrar</label>
							<div class="col-sm-10">
...
<?php $p_roles = array(); 
						...
						<div class="form-group row">
								<label class="col-sm-12 form-control-label">Permisos</label>
						...
						<input id="file" type="hidden" class="form-control" name="id" value="{{$role->id}}">
								 ...
								 <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
										 ...
										 <a class="btn btn-white" href="{{ url('roles') }}">Cancelar</a>
