                ...
                <div class="col-lg-8">
                    <div class="ibox float-e-margins">
                        ...
                        {{ csrf_field() }}
                            ...
                            <label for="input-Default" class="col-sm-2 control-label">Precio 1</label>
                            <!--  title, Price  -->
							<div class="col-sm-3">
                                <input type="text" class="form-control price_title"  id="" name="title[]" placeholder="Concepto">
                            </div> 
                            <div class="col-sm-2">
                                <input type="text" class="form-control price_amt" id="" name="price[]" placeholder="Precio">
                            </div>
                            
                            <div class="col-sm-2">
                                <input type="button" name="add_row" id="add_row" class="uibutton" value="Agregar otro" />
                            </div>
...
.upload_button { 
	margin-top:10px;
        ...
        $("body").on("click" , "#add_row", function() {
            ...
            var new_field = ' <div class="form-group"> <label for="input-Default" class="col-sm-2 control-label">Precio ' + counter + '</label>';
            new_field += ' <div class="col-sm-3"><input type="text" class="form-control price_title" id="" name="title[]" placeholder="Concepto"></div>';
            new_field += ' <div class="col-sm-2"> <input type="text" class="form-control price_amt" id="" name="price[]" placeholder="Precio"> </div>';
            
            new_field += ' <a href="javascript:void(0)" id="' + counter + '" class="remove_field">Remover</a>  </div>';
