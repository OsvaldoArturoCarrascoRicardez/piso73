                ...
                <div class="col-lg-8">
                    <div class="ibox float-e-margins">
						...
						<div class="form-group" id="price_div">
                            <label for="input-Default" class="col-sm-2 control-label">Precio {{$key+1}}</label>
                            <div class="col-sm-3">
                            ...
                            @if($key == 0)
                            <div class="col-sm-2">
                                <input type="button" name="add_row" id="add_row" class="uibutton" value="Agregar +" />
                            </div>
							@endif
							 @if($key > 0)
							<a href="javascript:void(0)" id="{{$key+1}}" class="remove_field" >Remover</a>  
						@endif
						</div>
