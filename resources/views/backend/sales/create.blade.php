...
//ALTER TABLE `customers` ADD `comments` VARCHAR(255) NULL;
 ...
 añadir es, 
 tomado del tempcreate.balde.php
 funcionando propinas, 
				...
				<div class="col-sm-12">
					...
					<div class="ibox" style="margin-bottom: 0px;">
						<div class="ibox-title">
							<h5>@lang('pos.cart_items') Temporal<span id="TableNo"> </span></h5>
						</div>
...
//---		
	...
	?>	
		...
		const __payment_with = $( "#payment_type" ).val();
		//--  change.toFixed( 2 ) 
		var  totalCardPay = __total_given * 1.03;
		...
		if ("Card" === __payment_with){
			...
			// var pre_tot_card = total_en_pantalla * 1.03;
		...
		$.ajax( {
			...
			success: function ( msg ) {
				...
				swal( {
					...
					{{-- Nueva funcionalidad, reemplazado. en sig. versión --}}
					if (msg.url){
						window.open( msg.url, "_blank" );
					}
					
					// 2022-07-20  temp function__
setTimeout( function () {
